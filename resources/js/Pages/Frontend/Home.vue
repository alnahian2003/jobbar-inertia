                ...
                <div class="py-24 sm:py-32 lg:pb-40">
                    <div class="px-6 mx-auto max-w-7xl lg:px-8">
                        <div class="max-w-2xl mx-auto text-center">
                            ...
                            >
                                <span class="font-extrabold text-indigo-300"
                                    >Jobbar</span
                                >
                                the ultimate job seeker's toolkit
                            </h1>
                            <p class="mt-6 text-lg leading-8 text-gray-300">
                                Seeking your dream job or the perfect candidate?
                                Explore our vast network of opportunities across
                                industries.
                            </p>
                            ...
                            <form @submit.prevent="filter" class="mt-10">
                                <div class="relative w-full">
                                    <svg
                                        class="absolute hidden text-white left-4 top-5 sm:block md:left-8 md:top-7"
                                        width="20"
                                        height="20"
                                        viewBox="0 0 20 20"
                                        fill="none"
                ...
                <div class="grid grid-cols-12 lg:gap-12">
                    <div class="col-span-12" id="find-job">
                        ...
                        <div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <p
                                                        class="px-2 py-1 text-xs rounded-md w-fit bg-gray-300/30 text-white/70"
                                                    >
                                                        {{
                                                            job.employment_type
                                                                .label
                                        ...
                                        <Link
                                            class="hidden items-center gap-1.5 rounded-lg bg-gray-300/30 px-4 py-2.5 text-indigo-300 transition group-hover:bg-indigo-500 group-hover:text-white group-hover:duration-500 md:flex"
                                            :href="
                                                route(
                                                    'frontend.job_details',
                                                    job.id
                            ...
                            <template v-else>
                                <h4
                                    class="my-4 text-xl font-semibold text-center text-white/80"
                                >
...
const { jobs, job_count, searchQuery } = usePage().props;
